...
CUDA_VISIBLE_DEVICES=$GPUS THEANO_FLAGS=mode=FAST_RUN,floatX=float32,device=cuda0,gpuarray.preallocate=0.8,scan.allow_output_prealloc=True python $NEMATUS/nematus/nmt.py \
